      ...
      <main className="flex-1 pt-16">
        ...
        <section className="relative py-16 sm:py-20 lg:py-28 overflow-hidden">
          ...
          <div className="absolute inset-0">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[600px] bg-red-500/[0.07] rounded-full blur-[120px] animate-pulse-ring" />
            <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-blue-500/[0.05] rounded-full blur-[100px] animate-float-3d" />
            <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-amber-500/[0.05] rounded-full blur-[100px] animate-float-3d" style={{ animationDelay: '2s' }} />
          </div>
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <FadeIn delay={0.1}>
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-display font-bold text-white mb-4 tracking-tight drop-shadow-xl">
                ราคาเรียบง่าย{' '}
                <span className="bg-gradient-to-r from-red-400 via-rose-400 to-orange-400 bg-[length:200%_auto] animate-text-gradient bg-clip-text text-transparent text-glow-premium">
                  โปร่งใส
                </span>
              </h1>
            </FadeIn>
        ...
        <section className="py-16 sm:py-20 lg:py-28">
          <div className="max-w-6xl mx-auto px-3 sm:px-6 lg:px-8">
            ...
            <FadeIn delay={0.1}>
              <div className="overflow-x-auto rounded-2xl border border-neutral-800/50 glass-premium">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
              {AI_MODELS.map((model, index) => (
                <motion.div
                  ...
                  className="p-3 sm:p-4 rounded-xl bg-neutral-900/50 border border-neutral-800/50 hover:border-primary-500/50 hover:shadow-premium transition-all duration-300 hover-lift"
                >
            ...
            <div className="space-y-3 sm:space-y-4">
              {content.faqs.map((faq, index) => (
                <FadeIn key={faq.question} delay={index * 0.05}>
                  <div className="p-4 sm:p-6 rounded-xl bg-neutral-900/50 border border-neutral-800/50 hover:border-primary-500/50 hover:shadow-premium transition-all duration-300 hover-lift">
        ...
        <section className="relative py-16 sm:py-20 overflow-hidden">
          ...
          <div className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <Button
              variant="primary"
              size="lg"
              className="bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-500 hover:to-rose-500 border-0 text-white shadow-premium w-full sm:w-auto hover-lift border-glow-premium rounded-xl"
              asChild
            >
